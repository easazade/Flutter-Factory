...
abstract class $CarCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String brand});
}
...
class _$_Car implements _Car {
  const _$_Car({required this.name, required this.brand});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, brand);
...
abstract class _Car implements Car {
  const factory _Car(
      {required final String name, required final String brand}) = _$_Car;
